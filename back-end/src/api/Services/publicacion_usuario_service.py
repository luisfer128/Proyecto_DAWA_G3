...
from src.api.Components.publicacion_usuario_component import PublicationsUserComponent
from flask import request
from flask_restful import Resource
from ..Components.jwt_component import JwtComponent

class GetUserPublicationsService(Resource):
    @staticmethod
    def post():
        try:
            HandleLogs.write_log("Ejecutando servicio para obtener publicaciones del usuario")
            ...
            resultado = PublicationsUserComponent.get_user_publications(user_id)
            if resultado['result']:
